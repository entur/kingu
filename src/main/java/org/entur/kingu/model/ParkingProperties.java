...
public class ParkingProperties
    ...
    @Transient
    protected List<org.entur.kingu.model.ParkingStayEnumeration> parkingStayList;
    ...
    public List<org.entur.kingu.model.ParkingStayEnumeration> getParkingStayList() {
