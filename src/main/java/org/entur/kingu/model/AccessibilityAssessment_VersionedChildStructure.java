...
public class AccessibilityAssessment_VersionedChildStructure
    ...
    protected org.entur.kingu.model.LimitationStatusEnumeration mobilityImpairedAccess = org.entur.kingu.model.LimitationStatusEnumeration.UNKNOWN;
    ...
    protected List<org.entur.kingu.model.AccessibilityLimitation> limitations;

    @Transient
    protected MultilingualStringEntity comment;

    public org.entur.kingu.model.LimitationStatusEnumeration getMobilityImpairedAccess() {
        return mobilityImpairedAccess;
    }

    public void setMobilityImpairedAccess(org.entur.kingu.model.LimitationStatusEnumeration value) {
        this.mobilityImpairedAccess = value;
    }

    public List<org.entur.kingu.model.AccessibilityLimitation> getLimitations() {
        return limitations;
    }

    public void setLimitations(List<org.entur.kingu.model.AccessibilityLimitation> value) {
