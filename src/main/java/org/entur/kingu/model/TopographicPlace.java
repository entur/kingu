...
public class TopographicPlace extends Place {
    ...
    @Embedded
    protected org.entur.kingu.model.CountryRef countryRef;
    ...
    public TopographicPlace(org.entur.kingu.model.EmbeddableMultilingualString name) {
        super(name);
    }
    ...
    public org.entur.kingu.model.CountryRef getCountryRef() {
        return countryRef;
    }

    public void setCountryRef(org.entur.kingu.model.CountryRef value) {
