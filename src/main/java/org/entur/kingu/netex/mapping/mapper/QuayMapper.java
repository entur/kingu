...
public class QuayMapper extends CustomMapper<Quay, org.entur.kingu.model.Quay> {
    @Override
    public void mapAtoB(Quay quay, org.entur.kingu.model.Quay quay2, MappingContext context) {
        ...
        if (quay.getAlternativeNames() != null &&
            ...
            List<org.entur.kingu.model.AlternativeName> alternativeNames = new ArrayList<>();
    ...
    @Override
    public void mapBtoA(org.entur.kingu.model.Quay quay, Quay quay2, MappingContext context) {
        ...
        if (quay.getAlternativeNames() != null &&
            ...
            for (org.entur.kingu.model.AlternativeName alternativeName : alternativeNames) {
