...
import org.entur.kingu.netex.mapping.NetexMappingException;
import org.entur.kingu.repository.TagRepository;
...
import static org.entur.kingu.netex.mapping.mapper.TagKeyValuesMapper.TAG_PREFIX;
...
public class DataManagedObjectStructureMapper extends CustomMapper<DataManagedObjectStructure, org.entur.kingu.model.DataManagedObjectStructure> {
     ...
     */
    private static final Map<String, BiConsumer<String, org.entur.kingu.model.DataManagedObjectStructure>> tiamatEntitySetFunctions = new ImmutableMap.Builder<String, BiConsumer<String, org.entur.kingu.model.DataManagedObjectStructure>>()
