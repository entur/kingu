...
public class FareZoneMapper extends CustomMapper<FareZone, org.entur.kingu.model.FareZone> {

    final ObjectFactory objectFactory = new ObjectFactory();

    @Override
    public void mapAtoB(FareZone netexFareZone, org.entur.kingu.model.FareZone tiamatFareZone, MappingContext context) {
