...
public class StopPlaceMapper extends CustomMapper<StopPlace, org.entur.kingu.model.StopPlace> {
    ...
    @Override
    public void mapBtoA(org.entur.kingu.model.StopPlace stopPlace, StopPlace netexStopPlace, MappingContext context) {
        ...
        if (stopPlace.getAlternativeNames() != null &&
            ...
            List<org.entur.kingu.model.AlternativeName> alternativeNames = stopPlace.getAlternativeNames();
