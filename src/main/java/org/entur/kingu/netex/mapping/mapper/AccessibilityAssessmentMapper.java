...
@Component
public class AccessibilityAssessmentMapper extends CustomMapper<AccessibilityAssessment, org.entur.kingu.model.AccessibilityAssessment> {

    @Autowired
    private NetexIdMapper netexIdMapper;

    @Override
    public void mapAtoB(AccessibilityAssessment accessibilityAssessment, org.entur.kingu.model.AccessibilityAssessment accessibilityAssessment2, MappingContext context) {
    ...
    @Override
    public void mapBtoA(org.entur.kingu.model.AccessibilityAssessment accessibilityAssessment, AccessibilityAssessment accessibilityAssessment2, MappingContext context) {
