...
import static org.entur.kingu.netex.mapping.mapper.DataManagedObjectStructureMapper.CHANGED_BY;
import static org.entur.kingu.netex.mapping.mapper.DataManagedObjectStructureMapper.VERSION_COMMENT;
import static org.entur.kingu.netex.mapping.mapper.StopPlaceMapper.IS_PARENT_STOP_PLACE;

/**
 * Note: Implemented because of an issue with using
 * CustomMapper<EntityStructure, org.entur.kingu.model.EntityStructure>
