...
public class TopographicPlaceQueryFromSearchBuilder {
    ...
    public Pair<String, Map<String, Object>> buildQueryString(TopographicPlaceSearch topographicPlaceSearch) {
        VersionValidity versionValidity = topographicPlaceSearch.getVersionValidity();

        if(versionValidity == null) {
            versionValidity = VersionValidity.CURRENT;
        }
        ...
        if (VersionValidity.CURRENT.equals(versionValidity)) {
        ...
        } else if (VersionValidity.MAX_VERSION.equals(versionValidity)) {
