...
import static org.entur.kingu.repository.StopPlaceRepositoryImpl.SQL_LEFT_JOIN_PARENT_STOP;
import static org.entur.kingu.repository.StopPlaceRepositoryImpl.SQL_NOT_PARENT_STOP_PLACE;
import static org.entur.kingu.repository.StopPlaceRepositoryImpl.createLeftJoinParentStopQuery;
...
public class StopPlaceQueryFromSearchBuilder {
    ...
    public static final VersionValidity DEFAULT_VERSION_VALIDITY = VersionValidity.CURRENT;
...
//                     "  AND similarity(s.name_value , s2.name_value) > :similarityThreshold ";
     ...
     */
    private static final VersionValidity defaultVersionValidity = VersionValidity.CURRENT;
    ...
    public Pair<String, Map<String, Object>> buildQueryString(ExportParams exportParams) {
        ...
        final VersionValidity versionValidity;
        ...
        } else if (VersionValidity.CURRENT.equals(versionValidity)) {
            operators.add("and");
        ...
        } else if (VersionValidity.CURRENT_FUTURE.equals(versionValidity)) {
            operators.add("and");
            parameters.put("pointInTime", Timestamp.from(Instant.now()));
        ...
        } else if (!stopPlaceSearch.isAllVersions() && VersionValidity.MAX_VERSION.equals(stopPlaceSearch.getVersionValidity())) {
